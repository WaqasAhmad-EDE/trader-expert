...
@Component({
  selector: "confirm-delete-account-profile",
  templateUrl: "./confirm-delete-account.page.html",
  styleUrls: ["./confirm-delete-account.page.scss"],
})
export class ConfirmDeleteAccountPage implements OnInit {
  rootPage: any
  ...
  constructor(
    ...
    this.savedPassword = JSON.parse(localStorage.getItem('loggedinUser') as string) || null
  }
  async ngOnInit() {
